...
import com.example.challenge2.SplashScreen
import java.util.*
...
class NotificationService : IntentService("NotificationService") {
    ...
    companion object {
        ...
        const val CHANNEL_ID = "com.example.challenge2.notification.CHANNEL_ID"
        ...
        if (timestamp > 0) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                mNotification = Notification.Builder(this, CHANNEL_ID)
                    ...
                    .setLargeIcon(BitmapFactory.decodeResource(res, R.drawable.mask))
                    .setAutoCancel(true)
